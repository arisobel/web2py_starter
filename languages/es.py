...
'Administration area': 'Área de adminstración',
...
'First name': 'Nombre',
"For being the first access, please enter a password for the Administrator user 'admin'": "Por ser el primer acceso por favor introduzca una contraseña para el usuario Administrador 'admin'",
...
'includes': 'incluye',
'Index': 'Índice',
'Insert here your content': 'Inserte aquí su contenido',
...
'Menu Detalhe': 'Menu detalle',
'Menu Detalhes': 'Menu detalles',
'Menu manage': 'Gestión de menúes',
...
'Welcome to Starter Web2py - Admin Lte!': 'Bienvenido a Starter Web2py - Admin Lte!',
