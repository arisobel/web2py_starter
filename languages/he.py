...
'%(nrows)s records found': '%(nrows)s נמצאו רשומות',
'%s': '%s',
'%s %%{row} deleted': '%s רשומות נמחקו',
'%s %%{row} updated': '%s רשומות עודכנו',
'%s selected': '%s נבחר',
'%s students registered': '%s נרשמו תלמידים',
'%Y-%m-%d': '%Y-%m-%d',
'%Y-%m-%d %H:%M:%S': '%Y-%m-%d %H:%M:%S',
'(requires internet access)': '(דורש גישה לאינטרנט)',
'(requires internet access, experimental)': '(דורש גישה לאינטרנט, ניסיוני)',
...
'>=': '>=',
'?': '?',
'@markmin\x01An error occured, please [[reload %s]] the page': 'אירעה שגיאה, [[טען מחדש את %s] הדף',
'@markmin\x01Searching: **%s** %%{file}': 'מחפש: **%s** files',
...
'Add breakpoint': 'הוסף נקודת עצירה',
...
'Admin': 'מערכת נהול',
'Admin design page': 'דף עיצוב של המערכת נהול ',
...
'admin disabled because too many invalid login attempts': 'מערכת נהול הושבת בגלל ניסיונות כניסה פסולות  רבים מדי',
...
'Admin language': 'שפת מערכת נהול ',
'Admin versioning page': 'Admin versioning page',
'Administration area': 'אזור ניהול',
...
'Graph Model': 'Graph Model',
'Groups': '',
'Groups manage': 'ניהול קבוצות',
'Grupos': 'קבוצות',
'Hebrew': 'עברית',
'Help': 'עזרה',
'here': 'כאן',
'Hide/Show Translated strings': 'הסתר / הצג מחרוזות מתורגמות',
'Highlight current line': 'הדגש את הקו הנוכחי',
'Hits': 'Hits',
'Home': 'דף בית',
...
'Insert here your content': 'הכנס כאן את התוכן שלך',
...
'Menu': 'תפריט',
'Menu details': 'פרטי תפריט',
'Menu Detalhe': 'פרט תפריט',
'Menu manage': 'ניהול תפריט',
'Menu Master': 'תפריט המאסטר',
'Menu master': 'תפריט המאסטר',
'merge': 'מזג',
'Models': 'מבני נתונים',
'models': 'מבני נתונים',
...
'Role': 'תַפְקִיד',
'Roles': 'תפקידים',
'Rows in Table': 'שורות בטבלה',
'Rows in table': 'רשומות בטבלה',
'Rows selected': 'רשומות נבחרו',
'rules are not defined': 'כללים אינם מוגדרים',
'Run tests': 'הפעל בדיקות',
...
'web2py upgraded; please restart it': 'web2py שודרגה; נא אתחל מחדש',
'Working...': 'Working...',
